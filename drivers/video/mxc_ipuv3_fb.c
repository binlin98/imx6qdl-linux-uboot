...
//+++WWJ
	debug("%s called ipu_di_pix_fmt = %d\n", __func__, mxc_fbi->ipu_di_pix_fmt);
	debug("IPU_PIX_FMT_RGB24 = %d\n", IPU_PIX_FMT_RGB24);
	/*
...
//+++WWJ
			debug("set pix_fmt to IPU_PIX_FMT_RGB666\n");
			params.mem_dp_bg_sync.out_pixel_fmt =
				IPU_PIX_FMT_RGB666;
		}
	}
...
//+++WWJ
	debug("WWJ=========in_pixel_fmt = %d\n", params.mem_dp_bg_sync.in_pixel_fmt);
...
{
//+++WWJ
	debug("%s======smem_len = %d, yres_virtual = %d, line_length = %d\n",
...
//+++WWJ
	printf("%s========interface_pix_fmt = %d\n", __func__, interface_pix_fmt);
	...
	fbi->fix.smem_len = fbi->var.yres_virtual * fbi->fix.line_length;
//+++WWJ
	debug("%s========line_length = %d, yres_virtual = %d\n", __func__, fbi->fix.line_length,
